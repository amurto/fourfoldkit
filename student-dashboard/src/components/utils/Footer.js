    ...
    return (
        <div className="footer">
            <div className="footer-copyright"  onClick={showHandler}>
                ...
                {show ? <Button style={{ backgroundColor: "#ffcce6", color: "black" }}>HIDE</Button> : <Button style={{ backgroundColor: "black", color: "#ffcce6" }}>CONTACT US</Button>}
                </div>
            </div>
            <div className={show ? "contact-list" : "contact-list-hidden"}>
                <Row className="contact-list-item">
                    <Col xs={1} sm={1}><LanguageIcon /></Col>
                    <Col xs={11} sm={11} style={{ paddingLeft: "15px" }}><a style={{ color: "#ffcce6", textDecoration: "none" }}href="http://localhost:3000/">Website</a></Col>
                </Row>
                <Row className="contact-list-item">
